...
#include "util.h" //for a uniform max value.

using namespace std;

#define MY_MAX_FLOAT MYMAX
...
{
  //unsigned int i = ( unsigned int )( 256 * sqrt(f) ); //this is for lighter colors ranges.
  unsigned int i = ( unsigned int )( 256 * f );
  if (i > 255) i = 255;
  if (i < 0 ) i = 0;
  return i;
}
